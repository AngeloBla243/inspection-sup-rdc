        ...
        <section class="content">
            <div class="container-fluid">
                <div class="card card-primary">
                    <form action="{{ route('admin.inspecteur.update', $inspecteur->id) }}" method="post"
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name"
                                    value="{{ old('name', $inspecteur->name) }}" placeholder="Entrez le nom">
                                @error('name')
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" name="email"
                                    value="{{ old('email', $inspecteur->email) }}" placeholder="Entrez l'email">
                                @error('email')
                                    <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                @if ($inspecteur->profile_picture)
                                    <div class="mb-2">
                                        <img src="{{ $inspecteur->profile_picture_url }}" class="img-thumbnail"
